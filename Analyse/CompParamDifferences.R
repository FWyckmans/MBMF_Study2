...
# Stress excluded
MainAOV(d, VoI = "w", Groups = c("Sample"), RemoveOutTechnique = NA)
MainAOV(d, VoI = "MBsw", Groups = c("Sample"), RemoveOutTechnique = NA)
MainAOV(d, VoI = "MBURsw", Groups = c("Sample"), RemoveOutTechnique = NA)
